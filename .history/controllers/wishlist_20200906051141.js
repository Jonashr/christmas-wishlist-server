...
wishlistRouter.post('/', async(req, res, next) => {
  ...
  try {
    ...
    console.log('Time elapsed method', calculateTimeElapsedFromDateAToDateB(userProfiles.data[2].birthdate, moment()))
    calculateTimeElapsedFromDateAToDateB(moment('2010-05-09', 'YYYY-DD-MM'), moment())
