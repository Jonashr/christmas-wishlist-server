...
const dateTimeCalculationHelpers = require('../helpers/dateTimeCalculationHelpers')
...
wishlistRouter.post('/', async(req, res, next) => {
  ...
  try {
    ...
    console.log('Time elapsed method', dateTimeCalculationHelpers.calculateTimeElapsedBetweenNowAndCurrentDate(moment(), moment('2010-08-09', 'YYYY-DD-MM')))
